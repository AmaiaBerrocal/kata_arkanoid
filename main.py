...
class Game:
    ...
    def __init__(self):
        ...
        self.text_game_over = self.font.render("GAME OVER", True, YELLOW)
        self.text_reinicio = self.font.render("Pulse <SPACE> para reiniciar partida", True, WHITE)
    ...
    def gameOver(self):
        ...
        rect = self.text_reinicio.get_rect()
        self.screen.blit(self.text_reinicio, ((800 - rect.w)//2, 380))
